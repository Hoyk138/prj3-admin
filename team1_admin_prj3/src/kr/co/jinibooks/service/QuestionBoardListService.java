 ...
 * @author owner
 */
public class QuestionBoardListService {
	 ...
	 * @return
	 */
	public int totalCount(QuestionSearchVO sv) {
		int totalCnt = 0;
		QuestionDAO s_dao3 = QuestionDAO.getInstance();
		try {
			totalCnt = s_dao3.selectTotalCount(sv);
...
//		    }//end if 
	...
	// 현재 게시판의 페이지 인덱스 설정
	public String indexList(IndexListVO ilVO,QuestionSearchVO sVO) {
	...
	public boolean deletenotice(QuestionVO ceiVO){
		boolean flag = false;
