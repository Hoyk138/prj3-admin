...
public class BookMainService {
		...
		public JSONObject addBook(BookInsertVO biVO, MultipartFile multipartFile) {
			...
			System.out.println("C:/Users/owner/git/prj3-admin/team1_admin_prj3/WebContent/common/imagesbook/"+cate+"/"+multipartFile.getOriginalFilename());
			
			//2. 경로 설정
			File file = new File("C:/Users/owner/git/prj3-admin/team1_admin_prj3/WebContent/common/images/book/"+cate+"/"+multipartFile.getOriginalFilename());
