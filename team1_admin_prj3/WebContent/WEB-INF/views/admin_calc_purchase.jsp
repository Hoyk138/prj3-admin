...
<%-- <form class="form-inline" action="admin_calc_purchase.do" id="searchFrm">
...
<%-- <form class="form-inline" action="admin_calc_purchase.do" id="searchFrm" method="get">
...
<table class="table">
  ...
  <tbody>
	...
	<tr>
		...
		<c:choose>
			<c:when test="${purchase.pay_method eq 'card'}"><td><c:out value="카드"/></td></c:when>
			<c:when test="${purchase.pay_method eq 'deposit'}"><td><c:out value="무통장"/></td></c:when>
