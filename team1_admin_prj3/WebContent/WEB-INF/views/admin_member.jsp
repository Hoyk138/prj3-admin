...
<body>
	<div id="books">
		...
		<div id="container">
			...
			<div id="content" style=" height: 950px; overflow: hidden">
				...
				<div id="member_right" style=" margin-left: 200px; padding-left: 20px;">


					<!-- 회원 정보 검색 시작 -->
					<div id="member_searchbox"
						style="width: 550px; height: 220px; padding: 15px; border: 1px solid #333;  margin-left: 25px">
						...
						<div style="width: 500px; height: 50px; float: left;">
							...
							<div class="form-group">
								<label style="width: 110px; float: left; margin-top: 13px; margin-left: 50px">
									<strong>가입 일자</strong></label>
						...
						<div
							style="width: 500px; height: 50px; margin-top: 10px; margin-left: 200px; float: left">
					...
					<div
						style="width: 600px; height: 480px; padding: 15px; border: 1px solid #333; margin-top: 25px;overflow: auto">
